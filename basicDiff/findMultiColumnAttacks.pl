...
# This program discovers cases where a difference attack is possible
# given a set of conditions. It finds both positive and negative
# difference attacks. By negative, we mean that a negative condition
# is used to isolate a user. By positive, we mean that a positive
# condition is used to isolate a user.
#
# The output of this program is standard output. To run:
# `perl findMultiColumnAttacks.pl 0 > outputFile`
